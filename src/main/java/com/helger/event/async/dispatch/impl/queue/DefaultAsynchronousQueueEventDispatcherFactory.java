...
public class DefaultAsynchronousQueueEventDispatcherFactory implements IFactory <IAsynchronousEventDispatcher>
{
  ...
  public DefaultAsynchronousQueueEventDispatcherFactory (@Nonnull final IFactory <IAggregator <Object, ?>> aResultAggregateFactory,
  ...
  {
    return new AsynchronousQueueEventDispatcher (m_aResultAggregateFactory, m_aExceptionHandler);
  }
}
